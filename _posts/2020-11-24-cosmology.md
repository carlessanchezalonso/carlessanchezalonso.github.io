...
In this blog I will be posting about a variety of topics. Some of them will be unconnected to each other but many of them will have some link to cosmology as a context, because that is the field I work on. Therefore, I thought it would be appropriate to start by a brief descrition of cosmology as a field of study in physics. Later on I will also introduce galaxy surveys, which is even closer to what I actually do, but let's start by the basics and the big picture. 
